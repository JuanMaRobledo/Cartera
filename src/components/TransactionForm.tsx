...
export function buildTransactionPayload(form: TransactionFormValues): Record<string, unknown> {
...
export function TransactionForm({
  ...
  setForm: (updater: (prev: TransactionFormValues) => TransactionFormValues) => void;
  ...
  return (
    <form onSubmit={onSubmit} className="card space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, fxFromCurrency: e.target.value }))}
              required
            >
              <option value="">Elegir…</option>
              {currencies.map((c) => (
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, fxFromAmount: e.target.value }))}
              required
            />
          </div>
          <div>
            ...
            <select
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, fxToCurrency: e.target.value }))}
              required
            >
              <option value="">Elegir…</option>
              {currencies.map((c) => (
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, fxToAmount: e.target.value }))}
              required
            />
          </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <div>
          <label className="label">Tipo de cambio a moneda base</label>
          <input
            type="number"
            step="any"
            className="input"
            ...
            onChange={(e) => setForm((prev) => ({ ...prev, fxRateToBase: e.target.value }))}
          />
        </div>
      </div>
